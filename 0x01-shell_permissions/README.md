...
12-directory_permissions - Create a script that creates a directory called dir_school with permissions 751 in the working directory.
...
14-change_owner_and_group - Write a script that changes the owner to betty and the group owner to school for all the files and directories in the working directory.

15-symbolic_link_permissions - Write a script that changes the owner and the group owner of the file _hello to betty and school respectively. The file _hello is in the working directory The file _hello is a symbolic link
...
101-man_school - Create a man that looks exactly like this one and passes all checks.